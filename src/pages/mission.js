...
const CardCarousel = (props) => {
  const slides = props.cardslist.map(thing => (
    <Card image={thing['image']} heightp={100-thing['p']} percent={thing['p']} fruit={thing['name']} />
  ))
  return (
    <CarouselBasic>
      {slides}
      ...
      <Fader>
        ...
        <div className="abouttextcontainer">
          <div className="aboutsecondbit" style={{ width: '100%' }}>
            <div className="aboutsecondtext">
              <div className="aboutsecondtitle" style={{ textAlign: 'center' }}>
                The Problem
              </div>
              <div className='whyyyyy'>
